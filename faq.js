(function () {
  ...
  var FAQ = [
    ...
    { id:'costo', tags:['iscrizione','genitori'], pill:'⏱ 20 secondi',
      ...
      a:`La retta è deliberata ogni anno dal Consiglio d'Istituto. La retta intera confermata per l'A.S. 2026/27 è di <strong>1.600€ annui</strong>, comprensiva di vitto completo, alloggio, studio guidato, attività e trasporto Convitto–scuola — <a href="ammissione.html#tariffe">tabella completa con importi e scadenze delle rate &rarr;</a>. Essendo una struttura pubblica statale, e non un collegio privato, i costi sono accessibili. Per il preventivo aggiornato: <a href="mailto:convitto@alberghierorieti.it">convitto@alberghierorieti.it</a>.` },
    ...
    { id:'rientro-pomeridiano', tags:['vita','genitori'], pill:'⏱ 20 secondi',
      q:`Se non va a scuola al mattino, può comunque rientrare in Convitto nel pomeriggio?`,
      a:`Sì. Anche chi non ha frequentato le lezioni al mattino, arrivando quindi direttamente da casa, può essere riammesso in Convitto nel pomeriggio. Sono previste due modalità alternative: un genitore o un tutore lo accompagna di persona, oppure si fa pervenire all'educatore di turno — anche via e-mail, con successiva conferma telefonica — una documentazione attendibile che giustifichi l'assenza, insieme a un documento d'identità. In entrambi i casi l'educatore annota sempre il rientro sul registro. <a href="regolamento-guida.html#art-ritardo">Approfondisci nella guida al Regolamento (art. 27) &rarr;</a>` },
    ...
    { id:'dsa', tags:['genitori'],
      ...
      a:`Il supporto agli alunni con DSA o BES è definito dalla scuola attraverso il PDP o il PEI. In Convitto, l'educatore di riferimento segue l'applicazione di queste indicazioni durante lo studio guidato, restando in dialogo diretto con il Coordinatore di Classe e con i docenti — anche tramite Registro Elettronico e partecipazione ai Consigli di Classe. È importante comunicare la diagnosi al momento dell'iscrizione, allegando la documentazione clinica.` },
